...
function markExperienceAsSeen() {
    // Actualizar ambos inmediatamente
...
function flipDigit(
    ...
    topStatic.textContent =
        oldValue;

    bottomStatic.textContent =
        oldValue;

    topPanel.querySelector(
        "span"
    ).textContent = oldValue;

    bottomPanel.querySelector(
        "span"
...
function autoStartClock() {
    ...
    /*
     * =====================================================
     * USUARIO YA VIO EL VIDEO
     *
     * ENTRA DIRECTAMENTE AL CONTADOR REAL
     * =====================================================
     */
...
function onVideoEnded() {
     ...
     *
     * Desde este instante, si recarga la página,
     * solamente verá el contador.
     * =====================================================
     */

    markExperienceAsSeen();

    /*
     * Actualizamos la variable en memoria también.
     */
...
/* =========================================================
   20. FINALIZAR CUANDO LLEGA A 00:00:00
========================================================= */
...
/* =========================================================
   22. SI YA FUE VISTO, OCULTAR EL OVERLAY
========================================================= */

if (HAS_SEEN_VIDEO) {

    /*
     * No mostrar "TOCA / HAZ CLIC".
     * El contador aparece directamente.
     */
    ...
    /*
     * Iniciar directamente sin
     * necesidad de interacción.
     *
     * No hay audio aquí porque los
     * navegadores bloquean audio
